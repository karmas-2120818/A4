...
## Abstract 
I compared the data and was able to make serveral findings. I looked at a dataset of demographic information and then invetigated and then found out the differences between the black and white jail population. I was able to find out how much more black people are in prison than white people. Using the map I was able to see the differences between different states to see how see roughly how many black people were in jail in each state. It was really interesting to see because there were some states that I didn't think would have a high jail population of blacks. 


## Introduction 
The social issues related to this data set are that there is a good variety of minority groups getting imprisoned as well as getting jail time.It raises concerns since there are more colored people in jail and prison. There is more black people than any other racial group. I think that black people feel more targeted and are getting jail time. 
The indirect and direct stakeholders are impacted by research by drawing upon conclusions quickly. The stakeholders become more aware of everyone in jail/prison and are aware. The stakeholders are writers, journalists, and bloggers. There are different people interpreting different parts of the data set. The two questions I answered are: What is the difference between Black and White jail rate from 1990-2018? and How does the Black Jail population vary by State?.
